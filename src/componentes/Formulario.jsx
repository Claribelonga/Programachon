    ...
    return( 
        <div className='Panel' style={{backgroundColor:"lightgray"}}>
            <form className="Formulario">
                ...
                <select name="categorias" id="categ" onChange={(e) => setDato("prioridad",e.target.value)}>
                    <option value="hogar">Hogar</option>
                    <option value="escuela">Escuela</option>
                    <option value="trabajo">Trabajo</option>
                </select>
                <select name="prioridad" id="priori" onChange={(e) => setDato("categoria",e.target.value)}>
